...
ORDER BY 
  ano ASC, mes ASC;
```
As consultas SQL utilizadas neste projeto estão disponíveis [aqui](https://github.com/carolcalandrine/Projeto-EcoViagens/blob/main/an%C3%A1lise-sql/Ecoviagens.sql).
